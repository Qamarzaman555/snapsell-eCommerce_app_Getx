...
class VariationController extends GetxController {
  ...
  void onAttributeSelected(
    ...
    // Show the selected variation iamge as Main Image
  ...
  bool _isSameAttributeValues(Map<String, dynamic> variationAttribute,
    ...
    // If any of the attributs are different then return. e.g. [Green,Large] x [Green,Small]
  ...
  Set<String?> getAttributeAvailablilityInVariation(
      List<ProductVariationModel> varaition, String attributeName) {
    // Pass the variations to check which attributes are available  and stock is not 0
    final availableVariationAttributeValues = varaition
        .where((variation) =>
